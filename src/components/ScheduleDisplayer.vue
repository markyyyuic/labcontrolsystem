<template>
 ...
 <div v-if="morningClasses.length > 0" class="text-lg mb-1 text-center text-pink-700">Morning Classes</div>
  ...
  <div v-if="afternoonClasses.length > 0" class="text-lg mb-1 text-center text-pink-700">Afternoon Classes</div>
